...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Create and manage professional digital banking experiences." },
      { property: "og:title", content: "TheMixWeb — Multi-Tenant Banking Platform" },
      { property: "og:description", content: "Create and manage professional digital banking experiences." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "TheMixWeb" },
