...
/**
 * Verify the bank exists. Single-owner platform: no owner authorization and
 * no render_status gate — every bank in bb_bank_drafts is operable.
 */
